...
SWEP.Purpose = "Serves as the basic rifle for Uzi Jungle"
SWEP.Spawnable = true 
...
SWEP.ViewModel				= "models/weapons/v_rif_ak47.mdl"	-- Model path to an already existing model or custom model (Model you see on screen)
SWEP.WorldModel				= "models/weapons/w_rif_ak47.mdl" -- Model path to an already existing model or custom model (Model you see when your character holds it out)
