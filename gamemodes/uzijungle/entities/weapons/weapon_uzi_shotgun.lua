...
SWEP.Purpose = "Serves as the basic shotgun in Uzi Jungle"
SWEP.Spawnable = true 
SWEP.Base = "weapon_uzi_slow_shotgun"

SWEP.UseHands = true
SWEP.HoldType = "shotgun" -- How should your playermodel hold your SWEP? 

SWEP.Primary.Sound = Sound("weapons/m3/m3-1.wav")
SWEP.ReloadSound = Sound("weapons/m3/m3_insertshell.wav")
...
SWEP.ViewModel				= "models/weapons/v_shot_m3super90.mdl"	-- Model path to an already existing model or custom model (Model you see on screen)
SWEP.WorldModel				= "models/weapons/w_shot_m3super90.mdl" -- Model path to an already existing model or custom model (Model you see when your character holds it out)
...
SWEP.Primary.Delay 			= 60/100 -- Time Delay before the next shot can happen
