...
SWEP.Name = "High-Capacity SMG"
SWEP.PrintName = "High-Capacity SMG"
SWEP.Purpose = "Serves as the High-Capacity SMG for Uzi Jungle"
SWEP.Spawnable = true 
...
SWEP.ViewModel				= "models/weapons/v_smg_p90.mdl"	-- Model path to an already existing model or custom model (Model you see on screen)
SWEP.WorldModel				= "models/weapons/w_smg_p90.mdl" -- Model path to an already existing model or custom model (Model you see when your character holds it out)
...
SWEP.Primary.DefaultClip 	= 35  -- How much bullets the user spawns with when the swep is given to them
...
SWEP.Primary.Recoil 		= .025  -- How much recoil the weapon has
SWEP.Primary.Delay 			= 60/960 -- Time Delay before the next shot can happen
