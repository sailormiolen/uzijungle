...
SWEP.Purpose = "Serves as the pistol in Uzi Jungle"
SWEP.Spawnable = true 
...
SWEP.ViewModel				= "models/weapons/v_pist_usp.mdl"	-- Model path to an already existing model or custom model (Model you see on screen)
SWEP.WorldModel				= "models/weapons/w_pist_usp.mdl" -- Model path to an already existing model or custom model (Model you see when your character holds it out)
SWEP.UseHands          	 	= true	-- Can you see your hands when you hold the model? 
SWEP.HoldType 				= "pistol" -- How should your playermodel hold your SWEP? 
...
SWEP.Primary.Delay 			= 60/240.0 -- Time Delay before the next shot can happen
